...
#DSUB -n step3_up_down_36_topk10_step10
#DSUB -A root.dallgdaxrjxylhlsktzu
#DSUB -q root.default
#DSUB -R cpu=32;gpu=1
#DSUB -N 1
#DSUB -oo ./logs/out_step3_up_down_36_topk10_step10.log
#DSUB -eo ./logs/err_step3_up_down_36_topk10_step10.log
...
python train_naicdm_step3.py --rank 0 --exp_name step3_up_down_36_topk10_step10 --topk 10 --resume_step2 > ./logs/step3_up_down_36_topk10_step10.log