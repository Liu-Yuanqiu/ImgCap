...
class COCO_KD:
    def __init__(self, text_field, stop_words, root_path, origin_cap):
        ...
        if os.path.exists(os.path.join(root_path, cached_train)):
            ...
            self.val_test_samples = json.load(open(os.path.join(root_path, cached_val_test), "r"))
            self.test_test_samples = json.load(open(os.path.join(root_path, cached_test_test), "r"))
        else:
            ...
            json.dump(self.val_test_samples, open(os.path.join(root_path, cached_val_test), "w"))
            json.dump(self.test_test_samples, open(os.path.join(root_path, cached_test_test), "w"))
