...
#DSUB -n kd_step100_sample10_loop10
#DSUB -A root.dallgdaxrjxylhlsktzu
#DSUB -q root.default
#DSUB -R cpu=32;gpu=1
#DSUB -N 1
#DSUB -oo ./logs/out_kd_step100_sample10_loop10.log
#DSUB -eo ./logs/err_kd_step100_sample10_loop10.log
...
python train_s2s.py --exp_name kd_step100_sample10_loop10 --num_timesteps 100 --sample_timesteps 10 --loop 10 --epoch1 100 --epoch2 200 > ./logs/kd_step100_sample10_loop10.log