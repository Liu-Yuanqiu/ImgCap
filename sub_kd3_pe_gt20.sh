...
#DSUB -R cpu=32;gpu=1
#DSUB -N 1
#DSUB -oo ./logs/out_kd3_pe_gt20.log
#DSUB -eo ./logs/err_kd3_pe_gt20.log
...
python train_s2s_pe_gt20.py --exp_name kd3_pe_gt20 --data_origin kd3 --epoch1 100 --epoch2 200 > ./logs/kd3_pe_gt20.log